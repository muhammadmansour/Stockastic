...
function AnalysisLoadingModal() {
	return (
<div id="default-modal" tabindex="-1" aria-hidden="true"
	class="fixed top-0 left-0 z-50 flex justify-center items-center w-full h-full bg-black/70">

	<div class="relative p-4 w-full max-w-2xl max-h-full">
		<div class="relative bg-white rounded-xl shadow-lg p-6 space-y-5">


			<div class="flex flex-col items-center space-y-4">

				<div class="relative w-20 h-20">
					<svg aria-hidden="true" class="w-20 h-20 text-gray-200 animate-spin fill-blue-600" viewBox="0 0 100 101" fill="none"
					...
					<div class="absolute inset-0 flex items-center justify-center">
						<svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-blue-800" fill="none" viewBox="0 0 24 24"
							stroke="currentColor">
							<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
								d="M11 19V6m-4 8v5m8-10v10m4-4v4" />
						</svg>
					</div>
				</div>

				<p class="text-lg font-bold text-center text-black">Please wait</p>
				<p class="text-base font-medium text-center text-black">Preparing your data analysis report...</p>
